package br.com.empessoa8.carcare.mask;
...
public abstract class Mask {
    ...
    public static final String MASK_KM = "######";
    public static final String MASK_AUTONOMIA = "##.#";
    public static final String MASK_COMBUSTIVEL = "#.##";
    public static final String MASK_PEDAGIO = "###.##";
    public static final String MASK_ABASTECER = "###.##";
    public static final String MASK_OCUPANTE = "#";
    public static final String MASK_DATA_SERVICO = "##/##/####";
    public static final String MASK_VALOR = "###.##";
