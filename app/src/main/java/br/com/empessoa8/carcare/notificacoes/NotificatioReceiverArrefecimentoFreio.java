...
public class NotificatioReceiverArrefecimentoFreio extends BroadcastReceiver  {

    @Override
    public void onReceive(Context context, Intent intent) {

        createNotification(context, "Manutenção Preventiva", "Arrefecimento e Freio", "Car Care");
    }
    private void createNotification(Context context, String msg, String msgText, String msgAlert) {
        PendingIntent notificIntent = PendingIntent.getActivity(context, 0,
                new Intent(context, Act_Arrefecimento_Freio.class), 0);
