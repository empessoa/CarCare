...
public class NotificatioReceiverOleoFiltro extends BroadcastReceiver  {

    @Override
    public void onReceive(Context context, Intent intent) {

        createNotification(context, "Manutenção Preventiva", "Oleos e Filtros", "Car Care");
    }
    private void createNotification(Context context, String msg, String msgText, String msgAlert) {
        PendingIntent notificIntent = PendingIntent.getActivity(context, 0,
                new Intent(context, Act_Oleo_Filtro.class), 0);
